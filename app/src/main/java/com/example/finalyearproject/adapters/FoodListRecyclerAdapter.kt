...
class FoodListRecyclerAdapter(
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        /*delete_btn.setOnClickListener {
            ...
            var positionOnDelete = viewHolder.adapterPosition
...
class FoodListRecyclerAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var name: TextView = rowView.findViewById(R.id.item_name_textView)
        var date: TextView = rowView.findViewById(R.id.item_expiration_textView)
        //var delete_btn: Button = rowView.findViewById(R.id.delete_button)
...
//alternative version for item deletion using a snackbar not the rowView
